...
def main():
    ...
    print('\n== 6. アップグレード効果と吸収（Hexirp 2023-11-15）の再現 ==')
    # 出典: ~/proofs/papers/hexirp/Hexirp_アップグレード効果について _ 巨大数研究 Wiki _ Fandom.html
    A = [(0, 0, 0), (1, 1, 1), (1, 1, 1)]
    Au = [(0, 0, 0), (1, 1, 1), (2, 1, 0), (1, 1, 1)]
    assert expand(A, 2) == [(0, 0, 0), (1, 1, 1), (1, 1, 0), (2, 2, 1)]
    assert expand(Au, 2) == [(0, 0, 0), (1, 1, 1), (2, 1, 0), (1, 1, 0), (2, 2, 1), (3, 2, 0)]
    # 上昇コピー (2,1,0)->(3,2,0): psi(W_(w+1)) 行列の尾がアップグレードで生成される
    # 吸収: (2,2,1) 終端の再展開は素の対角に退化
    assert expand([(0, 0, 0), (1, 1, 1), (1, 1, 0), (2, 2, 1)], 3) == \
        [(0, 0, 0), (1, 1, 1), (1, 1, 0), (2, 2, 0), (3, 3, 0)]
    # 非吸収: (3,2,0) 終端の再展開は (k,1,0)(k+1,2,1) を刻み続ける
    assert expand([(0, 0, 0), (1, 1, 1), (2, 1, 0), (1, 1, 0), (2, 2, 1), (3, 2, 0)], 3) == \
        [(0, 0, 0), (1, 1, 1), (2, 1, 0), (1, 1, 0), (2, 2, 1),
         (3, 1, 0), (4, 2, 1), (5, 1, 0), (6, 2, 1)]
    print('  (1,1,1) 結合の展開・吸収・非吸収の 4 例が記事と一致')
