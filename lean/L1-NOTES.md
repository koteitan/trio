...
# ⛔ 課題 L24: **`OrderT3` は今の `conv3` では偽**（2026-08-29、課題 R7）

## 0. これを最初に読むこと

**`OrderT3` / `SeqEmbT3` を証明しに行かないこと。** 反例がある。
`OrderT3_iff_seqemb`（`Dbms3.lean`, **証明ずみ**）より両者は同値なので、
`SeqEmbT3` の反例は `OrderT3` の反例である。
